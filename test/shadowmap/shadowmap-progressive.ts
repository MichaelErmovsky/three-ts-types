...
import { TransformControls } from 'three-ts-types/examples/jsm/controls/TransformControls';
import { ProgressiveLightMap } from 'three-ts-types/examples/jsm/misc/ProgressiveLightMap';
