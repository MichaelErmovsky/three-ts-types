...
import { FirstPersonControls } from 'three-ts-types/examples/jsm/controls/FirstPersonControls';
import { GLTFLoader } from 'three-ts-types/examples/jsm/loaders/GLTFLoader';
import { FontLoader } from 'three-ts-types/examples/jsm/loaders/FontLoader';
import { TextGeometry } from 'three-ts-types/examples/jsm/geometries/TextGeometry';
import { ShadowMapViewer } from 'three-ts-types/examples/jsm/utils/ShadowMapViewer';
