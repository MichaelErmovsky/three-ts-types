...
import { HDRCubeTextureLoader } from 'three-ts-types/examples/jsm/loaders/HDRCubeTextureLoader';
import { RGBMLoader } from 'three-ts-types/examples/jsm/loaders/RGBMLoader';
