...
import { ImprovedNoise } from 'three-ts-types/examples/jsm/math/ImprovedNoise';

import WEBGL from 'three-ts-types/examples/jsm/capabilities/WebGL';
...
function animate() {
    ...
    (mesh.material as THREE.RawShaderMaterial).uniforms.cameraPos.value.copy(camera.position);
    // mesh.rotation.y = - performance.now() / 7500;

    (mesh.material as THREE.RawShaderMaterial).uniforms.frame.value++;
