...
import { GrannyKnot } from 'three-ts-types/examples/jsm/curves/CurveExtras';
import { ParametricGeometry } from 'three-ts-types/examples/jsm/geometries/ParametricGeometry';
import { ParametricGeometries } from 'three-ts-types/examples/jsm/geometries/ParametricGeometries';
