...
import { FlyControls } from 'three-ts-types/examples/jsm/controls/FlyControls';
import { Lensflare, LensflareElement } from 'three-ts-types/examples/jsm/objects/Lensflare';
