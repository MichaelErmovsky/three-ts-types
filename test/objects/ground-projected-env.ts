...
import { GroundProjectedEnv } from 'three-ts-types/examples/jsm/objects/GroundProjectedEnv';
import { GLTFLoader } from 'three-ts-types/examples/jsm/loaders/GLTFLoader';
import { DRACOLoader } from 'three-ts-types/examples/jsm/loaders/DRACOLoader';
import { FlakesTexture } from 'three-ts-types/examples/jsm/textures/FlakesTexture';
