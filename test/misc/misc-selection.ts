...
import { SelectionBox } from 'three-ts-types/examples/jsm/interactive/SelectionBox';
import { SelectionHelper } from 'three-ts-types/examples/jsm/interactive/SelectionHelper';
