...
import { GPUComputationRenderer, Variable } from 'three-ts-types/examples/jsm/misc/GPUComputationRenderer';
import { SimplexNoise } from 'three-ts-types/examples/jsm/math/SimplexNoise';
