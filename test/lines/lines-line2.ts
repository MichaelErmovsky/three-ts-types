...
import { Line2 } from 'three-ts-types/examples/jsm/lines/Line2';
import { LineMaterial } from 'three-ts-types/examples/jsm/lines/LineMaterial';
import { LineGeometry } from 'three-ts-types/examples/jsm/lines/LineGeometry';
import * as GeometryUtils from 'three-ts-types/examples/jsm/utils/GeometryUtils';
