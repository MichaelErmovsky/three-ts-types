...
import { RoomEnvironment } from 'three-ts-types/examples/jsm/environments/RoomEnvironment';

import { LDrawLoader } from 'three-ts-types/examples/jsm/loaders/LDrawLoader';
import { LDrawUtils } from 'three-ts-types/examples/jsm/utils/LDrawUtils';
