...
import { SSRPass } from 'three-ts-types/examples/jsm/postprocessing/SSRPass';
import { ReflectorForSSRPass } from 'three-ts-types/examples/jsm/objects/ReflectorForSSRPass';
