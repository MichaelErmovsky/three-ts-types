...
import { CinematicCamera } from 'three-ts-types/examples/jsm/cameras/CinematicCamera';
import { BokehShaderUniforms } from 'three-ts-types/examples/jsm/shaders/BokehShader2';
